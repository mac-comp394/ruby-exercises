module DesugaringExercises
  ...
  #method parameters: recipients, event, message
  #block parameters: |x|
  ...
  # Copy the contents of the previous method here and remove this sugar.
  #
  # P.S. This one gets messy! Use line breaks and indentation to help. -- I didn't do this because I didn't feel like it was necessary!
